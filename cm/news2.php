...
if ($error == false) {
	echo "<h4>".$title."</h4>";
	$form = "<form name=\"newsform\" id=\"newsform\" action=\"newsadd.php\" method=\"POST\" onSubmit=\"javascript:submitnews()\">";
	...
	$form .= "<div><input type=\"submit\" value=\"Grabar\" /> <a href=\"?section=3&action=1\">Cancelar</a></div>";
} else {
	$form = "<p>Ocurri&oacute; un error. Reintentar la operaci&oacute;n. <a href=\"?section=3&action=1\">Volver</a></p>";
}
echo $form;
?>